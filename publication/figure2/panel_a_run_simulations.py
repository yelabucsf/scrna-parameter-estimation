...
def get_simulation_parameters(q=REFERENCE_Q):
    adata = sc.read(config.DATA_PATH + 'interferon_filtered.h5ad')
...
def run_variance(z_param, Nc, num_trials, rng):
    rows, details = [], []
...
def main():
    ...
    runners = {'mean': run_mean, 'variance': run_variance, 'correlation': run_correlation}
    ...
    for quantity in quantities:
        ...
        if quantity == 'mean':
            ...
            estimates, meta = runners[quantity](z_param, Nc, args.num_trials, rng)
