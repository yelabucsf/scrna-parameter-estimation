...
def estimate_variance(method, nc, trial): # x_param used for scaling for basics
    ...
    if method == 'naive':
        ...
        return memento.estimator.RNAHypergeometric(0.05).variance(data, size_factor)
...
if __name__ == '__main__':
    ...
    np.savez_compressed(DATA_PATH + 'smfish/variance/simulation_variances', variances=variance_estimates)
